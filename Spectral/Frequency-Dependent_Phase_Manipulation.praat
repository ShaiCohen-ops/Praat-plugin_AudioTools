...
# Version: 1.1 (2026) - Fixed phase-pattern viz loop (counter mutation)
# License: MIT License
...
clearinfo
writeInfoLine: "=== Phase Manipulation v1.1 (Optimized) ==="
...
if draw_visualization
    ...
    # Step through 0..5000 Hz in fixed increments. Use an integer index
    # and derive the frequency (do NOT mutate the for-counter, which in
    # Praat advances by 1 on top of any manual change -> wrong spacing).
    step = 25
    nSteps = 5000 / step
    prevF = 0
    prevShift = 0
