...
#   - Relabeled "Chebyshev II" as simplified (poles only, no stopband zeros).
#   - Response plot annotates whether audio used fast (Hann) or exact IIR.
#
# Citation:
...
procedure plotFrequencyResponse
    ...
    Font size: 7
    Colour: "{0.4, 0.4, 0.4}"
    Text: nyquist, "right", 7, "half", modeNote$
    Black
    Font size: 10
