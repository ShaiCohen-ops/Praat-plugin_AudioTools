...
#     0.6/7.6 inner-viewport margins, font-12 title, grey summary panel,
#     full-precision RGB). Content unchanged: LFO trajectory + output
#     spectrogram with the F1 sweep overlaid.
# ============================================================
...
if draw_visualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Dynamic Formant Sweeper: " + originalName$ + " (" + presetName$ + ")"
    ...
    # --- Panel 2: Output spectrogram with F1 overlay ---
    ...
    Text: 0.5, "centre", 0.5, "half", "LFO: " + fixed$(rate_Hz, 1) + " Hz | Range: " + string$(min_freq_Hz) + "-" + string$(max_freq_Hz) + " Hz | BW: " + string$(bandwidth_Hz) + " Hz | Mix: " + fixed$(dry_wet_mix * 100, 0) + "% | Yellow = F1 sweep"
    Font size: 10
    Colour: "Black"
endif
