...
#
# Changelog v0.2:
#   - Chunked grain processing, formant synthesis, density-scaled amplitude, viz
#
# Changelog v0.3:
...
#     spectrogram panels with F1/F2/F3 reference lines, grey summary panel).
#   - Replaced non-ASCII dash characters with ASCII for portability.
# ============================================================
...
procedure drawVisualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Formant Grain Texture: " + preset_name$
    ...
    # --- Panel 2: Spectrogram with F1/F2/F3 reference lines ---
    ...
    Text: 0.5, "centre", 0.5, "half", "Density: " + fixed$(grain_density, 0) + " grains/s | F0: " + fixed$(base_frequency_Hz, 0) + " Hz | Grains: " + string$(totalGrains) + " | Lines = avg F1/F2/F3"
    Font size: 10
    Colour: "Black"
    Line width: 1
endproc