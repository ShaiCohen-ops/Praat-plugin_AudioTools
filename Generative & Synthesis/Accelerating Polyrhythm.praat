...
form Accelerating Polyrhythm Generator
    ...
    comment === Pattern 1 (lower voice) ===
    integer Pattern1_beats 3
    real Pattern1_frequency_Hz 300
    real Pattern1_amplitude 0.4
    real Pattern1_pan -0.5
    
    comment === Pattern 2 (upper voice) ===
    integer Pattern2_beats 4
    real Pattern2_frequency_Hz 500
    real Pattern2_amplitude 0.4
    real Pattern2_pan 0.5
