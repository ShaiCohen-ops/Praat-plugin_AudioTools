...
#
# Changelog v0.2:
#   - Fixed iterated maps, x normalization, syntax, clamping, presets, spatial, viz
#
# Changelog v0.3:
#   - Fixed preset function labels: presets overrode the numeric function_type
#     but left function_type$ at the form default, so every preset reported
#     "sin(1/x)" in the info window and the plot title regardless of the actual
#     function. Each preset now sets function_type$ to match.
...
#   - Replaced non-ASCII characters (superscript two, arrows, en-dash).
# ============================================================
...
if preset = 2
    ...
    function_type = 3
    function_type$ = "Multi-sine: 2sin(3/x)+3cos(5/x)+..."
    spatial_mode = 2
    ...
    function_type = 13
    function_type$ = "Logistic Map (r=3.9)"
    control_rate_Hz = 500
...
if isIteratedMap = 0
    ...
    for cp to nControlPoints
        ...
        if function_type = 13 or function_type = 14
            ...
            # Henon: x[n+1] = 1 - a*x^2 + y, y[n+1] = b*x
...
procedure drawVisualization
    ...
    Font size: 14
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Chaotic Function: " + preset_name$ + " (" + function_type$ + ")"
    ...
    # --- Panel 2: Spectrogram ---
    Select outer viewport: 0, 8, 2.8, 4.9
    Select inner viewport: 0.75, 7.6, 2.95, 4.8
    selectObject: .disp
