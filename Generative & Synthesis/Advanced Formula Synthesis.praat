...
#   - Simple FM
#   - Competing Oscillators (φ, e ratios)
...
#   - Removed misleading formant analysis
#   - Added unique object naming
# ============================================================
...
for layer to number_of_layers
    ...
    # === Mode 2: Competing Oscillators (φ, e ratios) ===
...
procedure drawSpectrogram: .duration
    ...
    Font size: 12
    Colour: "Black"
    Text top: "no", "Formula Synthesis: " + preset_name$ + " (" + synthesis_mode$ + ")"
    ...
    Font size: 8
    Colour: "{0.4, 0.4, 0.4}"
    .paramText$ = "Base: " + fixed$(base_frequency_Hz, 0) + " Hz | Mod: " + fixed$(modulation_depth, 2) + " | Complexity: " + fixed$(complexity_factor, 1) + " | Layers: " + string$(number_of_layers)
