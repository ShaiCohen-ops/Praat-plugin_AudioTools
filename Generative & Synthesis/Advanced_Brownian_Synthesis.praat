...
procedure drawSpectrogram: .duration
    ...
    Font size: 14
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Brownian Synthesis: " + preset_name$ + " (" + synthesis_mode$ + ")"
    ...
    Text: 0.5, "centre", 0.5, "half", "Base: " + fixed$(base_frequency_Hz, 0) + " Hz | Step: " + fixed$(step_size, 1) + " | Drift: " + fixed$(drift_force, 2) + " | Layers: " + string$(number_of_layers) + " | " + .spatial$
    Font size: 10
    Colour: "Black"
    Line width: 1
endproc