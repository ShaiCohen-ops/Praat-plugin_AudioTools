...
procedure drawVisualization
    ...
    Font size: 14
    Colour: "Black"
    Text: 0.5, "centre", 0.7, "half", "No-Input Mixer — " + preset_name$
    Font size: 10
    Colour: "{0.4, 0.4, 0.4}"
    Text: 0.5, "centre", 0.2, "half", "Gain: " + fixed$(feedback_gain, 2) + " | Damp: " + fixed$(damping_factor, 2) + " | Instability: " + fixed$(analog_instability, 2)
    
    # === Filter Frequency Drift Plot ===
    Select outer viewport: 0, 7, 0.9, 2.6
    Colour: "{0.95, 0.95, 0.95}"
    Paint rectangle: "{0.95, 0.95, 0.95}", 0, 1, 0, 1
    
    Select inner viewport: 0.5, 6.5, 1.0, 2.5
    ...
    # === Spectrogram ===
    Select outer viewport: 0, 7, 2.8, 5.0
    Colour: "{0.85, 0.85, 0.85}"
    Draw inner box
    
    Select inner viewport: 0.5, 6.5, 2.9, 4.9
    ...
    Font size: 8
    Colour: "{0.4, 0.4, 0.4}"
    Text: 0.5, "centre", 0.5, "half", "Top: Filter frequency drift | Bottom: Spectrogram | Yellow line = resonance center"
