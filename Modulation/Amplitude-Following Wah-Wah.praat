...
#
# Changelog v0.2:
#   - Fixed formant count (was 10, now 1)
#   - Added input check
#   - Added visualization
#   - Added smoothing via intensity time step
# ============================================================
...
if draw_visualization
    ...
    Axes: 0, dur, 0, 1.1
    Paint rectangle: "{0.95, 0.95, 0.95}", 0, dur, 0, 1.1
    ...
    Paint rectangle: "{0.95, 0.95, 0.95}", 0, dur, min_cutoff - freqMargin, max_cutoff + freqMargin
    ...
    Font size: 7
    Colour: "{0.4, 0.4, 0.4}"
    Text: 0.5, "centre", 0.5, "half", "Loud → High freq (bright) | Quiet → Low freq (dark) | BW: " + string$(bw) + " Hz"
