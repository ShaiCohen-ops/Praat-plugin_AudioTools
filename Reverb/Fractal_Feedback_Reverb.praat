...
if draw_visualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Fractal Feedback Reverb: " + originalName$ + " (" + presetName$ + ")" + " | v0.4.1"
    ...
    Axes: 0, 1, 0, 1
    Text special: 0.5, "centre", 0.5, "bottom", "Helvetica", labelFont, "90", "Reverb " + fixed$(wet_dry_percent, 0) + "\%  "
    Select inner viewport: 0.60, 7.70, 1.6, 2.2
    Axes: 0, 1, 0, 1
    ...
    Font size: 6
    Text: 0.02, "left", 0.48, "half", "Recursive layers show the realized feedback hierarchy"
    Colour: "{0.25, 0.25, 0.35}"
    Font size: 6
    Text: 0.02, "left", 0.24, "half", "Dry/reference remains neutral; effect colour follows the transformed path"
