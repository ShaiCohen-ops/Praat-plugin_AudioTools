...
for layer from 1 to depth_layers
    ...
    for seg from 1 to divisions
        ...
        Formula (part): tStart, tEnd, 1, 1, "if col > " + delay_str$ + " then self + " + feedback_str$ + " * self[col - " + delay_str$ + "] * sin(pi * (col - " + segStart_str$ + ") / " + segSize_str$ + ") else self fi"
    endfor
endfor
