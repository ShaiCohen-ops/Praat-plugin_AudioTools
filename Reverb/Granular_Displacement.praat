...
if draw_visualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "Granular Displacement: " + originalName$ + " (" + presetName$ + ")" + " | v0.5.1"
    ...
    Axes: 0, 1, 0, 1
    Text special: 0.5, "centre", 0.5, "bottom", "Helvetica", labelFont, "90", "Granular " + fixed$(wet_dry_percent, 0) + "\%  "
    Select inner viewport: 0.60, 7.70, 1.6, 2.2
    Axes: 0, 1, 0, 1
    ...
    Select inner viewport: 0.60, 7.70, 2.6, 3.7
    ...
    Axes: 0, 1, 0, 1
    Text special: 0.5, "centre", 0.5, "bottom", "Helvetica", labelFont, "90", "Grains"
    Select inner viewport: 0.60, 7.70, 2.6, 3.7
    Axes: 0, totalDur, 0, 1.2
    Text bottom: "yes", "Time (s)"
    ...
    Font size: 6
    Text: 0.02, "left", 0.48, "half", "Displacement map represents the realized grain-time offsets"
    Colour: "{0.25, 0.25, 0.35}"
    Font size: 6
    Text: 0.02, "left", 0.24, "half", "The diagram encodes the transformation law rather than decorative motion"
