...
if draw_visualization
    ...
    Font size: 7
    Colour: "{0.3, 0.5, 0.8}"
    Text: duration * 0.85, "left", 1.05, "half", "Left"
    Colour: "{0.8, 0.5, 0.3}"
    Text: duration * 0.95, "left", 1.05, "half", "Right"
    
    # === Waveform Preview ===
    Select outer viewport: 0, 8, 5.1, 6.5
    Select inner viewport: 0.6, 7.6, 5.2, 6.4
    ...
    # === Info ===
    Select outer viewport: 0, 8, 6.5, 6.9
    Font size: 8
    Colour: "{0.4, 0.4, 0.4}"
