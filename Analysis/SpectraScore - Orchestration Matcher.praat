...
form SpectraScore Orchestration Matcher v0.2
...
writeInfoLine: "=== SpectraScore Orchestration Matcher v0.2 ==="
            ...
            for j from i + 1 to n_instruments
                ...
                if canPlay.can
                    ...
                    if allow_divisi or name_i$ <> name_j$
                        # Mix spectra
                        @getInstCentroid: i
                        cent_i = getInstCentroid.result
                        @getInstCentroid: j
                        cent_j = getInstCentroid.result
                        @getInstSpread: i
                        spr_i = getInstSpread.result
                        @getInstSpread: j
                        spr_j = getInstSpread.result
                        
                        mix_cent = (cent_i + cent_j) / 2
                        mix_spr = (spr_i + spr_j) / 2
                        mix_oe = (inst_odd_even_'i' + inst_odd_even_'j') / 2
                        ...
                        if combo_score < best_score
                            ...
                            best_inst_1 = i
                            best_inst_2 = j
                            appendInfoLine: "  Found: ", inst_name_'i'$, "+", inst_name_'j'$, " (", fixed$(combo_score, 4), ")"
                        endif
                    endif
                endif
            endfor
                ...
                if canPlay.can
                    for k from j + 1 to n_instruments
                        ...
                        if canPlay.can
                            ...
                            cent_j = getInstCentroid.result
                            @getInstCentroid: k
                            cent_k = getInstCentroid.result
                            @getInstSpread: i
                            spr_i = getInstSpread.result
                            @getInstSpread: j
                            spr_j = getInstSpread.result
                            @getInstSpread: k
                            spr_k = getInstSpread.result
                            
                            mix_cent = (cent_i + cent_j + cent_k) / 3
                            mix_spr = (spr_i + spr_j + spr_k) / 3
                            mix_oe = (inst_odd_even_'i' + inst_odd_even_'j' + inst_odd_even_'k') / 3
                            ...
                            if combo_score < best_score
                                ...
                                best_inst_2 = j
                                best_inst_3 = k
                                appendInfoLine: "  Found: ", inst_name_'i'$, "+", inst_name_'j'$, "+", inst_name_'k'$, " (", fixed$(combo_score, 4), ")"
                            endif
                        endif
                    endfor
                endif
                        ...
                        if canPlay.can
                            for m from k + 1 to n_instruments
                                ...
                                if canPlay.can
                                    ...
                                    spr_k = getInstSpread.result
                                    @getInstSpread: m
                                    spr_m = getInstSpread.result
                                    
                                    mix_cent = (cent_i + cent_j + cent_k + cent_m) / 4
                                    mix_spr = (spr_i + spr_j + spr_k + spr_m) / 4
                                    mix_oe = (inst_odd_even_'i' + inst_odd_even_'j' + inst_odd_even_'k' + inst_odd_even_'m') / 4
                                    ...
                                    if combo_score < best_score
                                        ...
                                        best_inst_3 = k
                                        best_inst_4 = m
                                        appendInfoLine: "  Found: ", inst_name_'i'$, "+", inst_name_'j'$, "+", inst_name_'k'$, "+", inst_name_'m'$, " (", fixed$(combo_score, 4), ")"
                                    endif
                                endif
                            endfor
                        endif
...
for p from 1 to best_n
    ...
    appendInfoLine: inst_name_'idx'$, ": H", harmonic_num, " (", fixed$(assignVoicing.target_freq, 1), " Hz) -> MIDI ", fixed$(assignVoicing.midi_note, 1), " + ", fixed$(assignVoicing.cents_offset, 1), " cents"
endfor
...
xml$ = xml$ + "    <creator type=""software"">Praat SpectraScore v0.2</creator>" + newline$
xml$ = xml$ + "  </identification>" + newline$
...
for p from 1 to best_n
    ...
    if enable_microtones and abs(cents_dev) > 10
        ...
        if abs_cents >= 37.5 and abs_cents <= 62.5
            if cents_dev > 0
...
if draw_visualization
    ...
    Font size: 14
    Colour: "Black"
    Text: 0.5, "centre", 0.5, "half", "SpectraScore: " + sound_name$
