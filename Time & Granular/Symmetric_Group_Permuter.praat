...
form Symmetric Group Permuter v2.2
...
if draw_visualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.62, "half", "Symmetric Group Permuter v2.2 - " + presetName$
    ...
    Text: 0.5, "centre", 0.58, "half", "Segment permutation and iteration in S(n)  |  S" + string$(nSegs) + "  |  source i -> position sigma^" + string$(iterations_k) + "(i)  |  cycle type " + sK_cycleType$ + "  |  " + segMethodName$
