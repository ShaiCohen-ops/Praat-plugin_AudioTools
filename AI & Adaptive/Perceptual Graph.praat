...
# Version: 3.0 (2025) - 3D visualization & transition analysis
# License: MIT License
...
form Perceptual Graph Explorer v3.0
...
clearinfo
writeInfoLine: "=============================================="
writeInfoLine: "  PERCEPTUAL GRAPH EXPLORER v3.0"
writeInfoLine: "=============================================="
appendInfoLine: ""
...
# 3. Dimension C: BRIGHTNESS (Spectral Centroid)
selectObject: originalSoundID
To Spectrum: "yes"
...
if numFrames < number_of_clusters
    removeObject: intensityID, harmonicityID, spectrumID
...
for k from 1 to number_of_clusters
    if clusterSize[k] > 0
        ...
        # Concatenate rest with crossfade
        if nRows > 1
            for r from 2 to nRows
                ...
                plusObject: frag
                Concatenate with overlap: overlap_time
                
                newSound = selected("Sound")
                removeObject: finalSound, frag
                finalSound = newSound
                Rename: clusterLabel$[k]
            endfor
        endif
...
if draw_visualization
    ...
    Font size: 12
    Colour: "Black"
    Text: 0.5, "centre", 0.7, "half", "##Perceptual Graph Explorer## | " + originalName$
    Font size: 9
    Colour: "{0.4, 0.4, 0.5}"
